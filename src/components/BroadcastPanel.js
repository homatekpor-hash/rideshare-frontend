...
function BroadcastPanel() {
  ...
  const templates = [
    ...
    { title: '⚠️ Maintenance', message: 'Ryde will undergo maintenance tonight from 12AM-2AM. Services may be temporarily unavailable.', target: 'all' },
    { title: '🎁 Promo', message: 'Special offer! Use promo code RYDE10 for GH₵ 10 off your next ride. Valid this weekend only!', target: 'riders' },
    { title: '💰 Driver Bonus', message: 'Complete 10 rides this week and earn a GH₵ 20 bonus! Offer valid until Sunday.', target: 'drivers' },
  ];
...
const styles = {
  ...
  targetRow: { display: 'flex', gap: '8px', marginBottom: '16px', flexWrap: 'wrap' },
